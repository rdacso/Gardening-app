...
def register_process():
    ...
    new_user = User(first_name=first_name, last_name=last_name, email=email, password=password, phone_number=phone_number, city=city, state=state, zipcode=zipcode, alerts=alerts)
